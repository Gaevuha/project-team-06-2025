import{a as c,S as V}from"./assets/vendor-C_cafi3u.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function A(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=A(s);fetch(s.href,a)}})();const o={artistsList:document.querySelector(".artists"),loadMoreBtn:document.querySelector(".load-more-btn"),learnMoreArtistBtns:document.querySelectorAll(".learn-more-artist-btn"),artists:document.querySelector(".list-artists"),modalAlbumList:document.querySelector(".modal-list__album"),backdropModalElem:document.querySelector(".backdrop"),closeModalBtn:document.querySelector(".close-btn-modal")},M="/project-team-06-2025/assets/sprite-BMp1TjPy.svg",Y="data:image/jpeg;base64,",U="icon-youtube",K="learn-more";function j(t,e){if(!t)return"No description available";const A=t.indexOf(".");return A!==-1&&A<=e?t.slice(0,A+1).trim():t.length<=e?t.trim():t.slice(0,e).trim()+"..."}function J(){const t=window.innerWidth;return t<768?60:t<1024?160:147}function E(){const t=J(),e=f.map(A=>{const n=(A.genres||[]).map(r=>`<li class="artist-genre">${r}</li>`).join(""),s=A.strArtistThumb||`${Y}`,a=j(A.strBiographyEN,t);return`
      ...
      `}).join("");o.artistsList.innerHTML=e}function C(t){t.style.display="block"}function b(t){t.style.display="none"}function S(){const t=document.querySelector(".load-more-btn");t.style.display="block"}function h(){const t=document.querySelector(".load-more-btn");t.style.display="none"}async function R(t){const{_id:e,strArtist:A,strArtistThumb:n,intFormedYear:s,intDiedYear:a,intMembers:r,strCountry:i,strGender:p,strBiographyEN:m,genres:d=[],albumsList:_=[]}=t,$=d.map(w=>`<li class="artist__genre-item">${w}</li>`).join("");console.log("genres:",d);const T=_.map(({strAlbum:w,intYearReleased:D,tracks:x=[]})=>{const N=x.map(({strTrack:H,intDuration:B,movie:l})=>{const O=Math.floor(B/6e4),F=String(Math.floor(B%6e4/1e3)).padStart(2,"0"),P=l!=null&&l.startsWith("http")?l:l?`https://${l}`:"";return`
        <li class="track__row">
  ...
  <li class="artist__info-item">
    ...
    <p class="artist__info-value">${p}</p>
  </li>
  <li class="artist__info-item">
...
<div class="artist__biography">
  ...
  `).join("");e.innerHTML=A}c.defaults.baseURL="https://sound-wave.b.goit.study/api";let f=[],g=1;const z=8;let k=0,v,y;const u=document.querySelector(".section-artists-loader");window.addEventListener("resize",()=>{clearTimeout(v),v=setTimeout(()=>{E()},300)});async function Q(t=1){const e={limit:8,page:t},A="/artists";try{return(await c.get(A,{params:e})).data}catch(n){throw console.error("Помилка при завантаженні артистів:",n.message),n}}C(u);Q(g).then(t=>{f=t.artists,k=Math.ceil(t.totalArtists/z),E(),b(u),g>=k?h():S(),y=f.map(({genres:e,_id:A})=>({genres:e,_id:A}))}).catch(t=>{console.error("Error during initial loading of artists:",t.message),b(u)});async function G(){o.loadMoreBtn.disabled=!0,h(),C(u),g+=1;try{const e=(await Q(g)).artists;if(y=[...y,...e.map(({genres:A,_id:n})=>({genres:A,_id:n}))],!e.length){alert("We're sorry, there are no more artists to load."),b(u),h();return}f=[...f,...e],E(),g>=k?h():S()}catch(t){console.error("Error loading new artists:",t.message)}finally{b(u),o.loadMoreBtn.disabled=!1}}o.loadMoreBtn.addEventListener("click",G);async function Z(t){const e=`/artists/${t}`;try{const A=await c.get(e);return console.log(A.data),A.data}catch(A){throw console.error("Помилка при отриманні артиста:",A.message),A}}async function X(t){const e=`/artists/${t}/albums`;try{return(await c.get(e)).data}catch(A){throw console.error("Помилка при отриманні альбомів артиста:",A.message),A}}async function tt(t=1){const e=[],A="/feedbacks",s={limit:25,page:t};try{const a=await c.get(A,{params:s});e.push(...a.data.data),console.log(a.data);const r=a.data.total,i=Math.ceil(r/25);for(let d=2;d<i;d++){const _=await c.get(A,{params:{limit:25,page:d}});e.push(..._.data.data)}const p=r-25*(i-1),m=await c.get(A,{params:{limit:p,page:i}});return e.push(...m.data.data),console.log(e),e}catch(a){throw console.error("Помилка при отриманні відгуків:",a.message),a}}async function At(t){if(t.target.tagName!=="BUTTON")return;const e=t.target.dataset.artistId,A=t.target,n=t.target.nextElementSibling;nt(A,n);try{const s=await Z(e),a=y.find(({_id:m})=>m===e),r=(a==null?void 0:a.genres)||[],{albumsList:i=[]}=await X(e),p={...s,genres:r,albumsList:i};R(p),at(),rt(A,n)}catch(s){console.error("Помилка при завантаженні артиста або альбомів:",s.message)}}function et(){L()}function st(t){t.target===t.currentTarget&&L()}o.artistsList.addEventListener("click",At);o.closeModalBtn.addEventListener("click",et);o.backdropModalElem.addEventListener("click",st);function I(t){t.key==="Escape"&&L()}function at(){o.backdropModalElem.classList.add("is-open"),document.body.classList.add("modal-open"),window.addEventListener("keydown",I)}function L(){o.backdropModalElem.classList.remove("is-open"),document.body.classList.remove("modal-open"),window.removeEventListener("keydown",I)}function nt(t,e){t.style.display="none",e.style.margin="0",e.style.display="block",e.style.height="27px"}function rt(t,e){t.style.display="",e.style.display="none"}const it="data:image/png;base64,",ot="data:image/png;base64,";function lt(){document.querySelectorAll(".rating").forEach(e=>{const A=parseFloat(e.dataset.rating)||0,n=Math.round(A),s=5-n;let a="";for(let r=0;r<n;r++)a+=`<i class="star-custom" style="background-image: url('${it}');"></i>`;for(let r=0;r<s;r++)a+=`<i class="star-custom" style="background-image: url('${ot}');"></i>`;e.innerHTML=a})}function ct(){const t=new V(".swiper",{slidesPerView:1,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0,type:"custom",renderCustom:function(e,A,n){return console.log(`current= ${A}`),console.log(`total = ${n}`),A===1?`
