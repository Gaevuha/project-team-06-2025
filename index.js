import{a as d,S as K,i as h}from"./assets/vendor-BT6NWGSC.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const A of document.querySelectorAll('link[rel="modulepreload"]'))a(A);new MutationObserver(A=>{for(const n of A)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(A){const n={};return A.integrity&&(n.integrity=A.integrity),A.referrerPolicy&&(n.referrerPolicy=A.referrerPolicy),A.crossOrigin==="use-credentials"?n.credentials="include":A.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(A){if(A.ep)return;A.ep=!0;const n=s(A);fetch(A.href,n)}})();const o={artistsList:document.querySelector(".artists"),loadMoreBtn:document.querySelector(".load-more-btn"),learnMoreArtistBtns:document.querySelectorAll(".learn-more-artist-btn"),artists:document.querySelector(".list-artists"),modalAlbumList:document.querySelector(".modal-list__album"),backdropModalElem:document.querySelector(".backdrop"),closeModalBtn:document.querySelector(".close-btn-modal")},M="/project-team-06-2025/assets/sprite-BN4b-4iD.svg",j="data:image/jpeg;base64,",J="icon-youtube",z="learn-more";function R(t,e){if(!t)return"No description available";const s=t.indexOf(".");return s!==-1&&s<=e?t.slice(0,s+1).trim():t.length<=e?t.trim():t.slice(0,e).trim()+"..."}function G(){const t=window.innerWidth;return t<768?60:t<1024?160:147}function F(){const t=G();o.artistsList.innerHTML="";const e=p.map(s=>{const a=(s.genres||[]).map(r=>`<li class="artist-genre">${r}</li>`).join(""),A=s.strArtistThumb||`${j}`,n=R(s.strBiographyEN,t);return`
      ...
      `}).join("");o.artistsList.insertAdjacentHTML("beforeend",e)}function C(t){t.style.display="block"}function y(t){t.style.display="none"}function S(){const t=document.querySelector(".load-more-btn");t.style.display="block"}function b(){const t=document.querySelector(".load-more-btn");t.style.display="none"}async function Z(t){const{_id:e,strArtist:s,strArtistThumb:a,intFormedYear:A,intDiedYear:n,intMembers:r,strCountry:i,strGender:f,strBiographyEN:u,genres:q=[],albumsList:O=[]}=t,$=q.map(E=>`<li class="artist__genre-item">${E}</li>`).join(""),x=O.map(({strAlbum:E,intYearReleased:N,tracks:H=[]})=>{const U=H.map(({strTrack:P,intDuration:L,movie:l})=>{const V=Math.floor(L/6e4),W=String(Math.floor(L%6e4/1e3)).padStart(2,"0"),Y=l!=null&&l.startsWith("http")?l:l?`https://${l}`:"";return`
        <li class="track__row">
      ...
      <li class="album-list-item">
        ...
        <ul class="album__track-list">${U}</ul>
      </li>
    `}).join(""),D=`
